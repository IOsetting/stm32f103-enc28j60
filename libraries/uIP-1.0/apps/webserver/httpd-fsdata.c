...
static const unsigned char index_html[] = {
  "<!DOCTYPE html>\n<html>\n<head>\n<meta charset=\"utf-8\">\n<title>中文It's a web page served by STM32F103 and ENC28J60测试</title>\n"
  "</head>\n<body>\n<table width=\"100%\">\n<tr><td><a href=\"/\">Front page</a></td><td><a href=\"files.shtml\">File statistics</a></td>\n"
  "<td><a href=\"stats.shtml\">Network statistics</a></td>\n<td><a href=\"tcp.shtml\">Network connections</a></td>\n"
  "</tr>\n</table>\n<br/><form>\n<center>LED:<input name=\"led\" /> <input type=\"submit\" value=\"OK\"><input type=\"reset\" value=\"Reset\"></center>\n</body>\n</html>"
};
...
const struct httpd_fsdata_file file_index_html[] = {{file_header_html, "/index.html", index_html, sizeof(index_html) - 1}};
